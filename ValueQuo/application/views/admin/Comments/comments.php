...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/Comments_controller/getcommentsdata') ?>',
            ...
            "fnCreatedRow": function (nRow, aData, iDataIndex) {
                $('td:eq(4) > label', nRow).attr('onclick', "changeStatus('id'," + aData[0] + ",'comments')");
            },
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
                            ...
                            <header>
                                ...
                                <div class="jarviswidget-ctrls" role="menu" style="float:right;">
                                    ...
                                    <a class="button-icon" href="<?php print base_url(); ?>admin/add_comments"><i class="fa fa-plus-circle"></i></a>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input name="select_all" value="1" type="checkbox" class="select_all"/></th>
                                                     <th>Name</th><th>Email</th><th>Comment</th><th>Status</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
