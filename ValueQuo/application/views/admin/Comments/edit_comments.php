...
<form class="smart-form" action="<?= site_url('admin/update_comments'); ?>" method="POST">
...
<input type="hidden" name="id" class="input-sm"  value="<?php echo $data->id ?>"/>
                                ...
                                <label class="label">Comment</label>
                                     <label class="input">
                                <input type="text" class="input-sm" id="comment" value="<?php echo setValue(set_value('comment'),$data->comment); ?>"  placeholder="Name" name="comment" >
