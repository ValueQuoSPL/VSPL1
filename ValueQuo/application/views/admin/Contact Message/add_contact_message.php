                ...
                <article class="col-sm-12 col-md-12 col-lg-6">
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        <header>
                            ...
                            <h2>Add contact_message</h2>
                        </header>
                        <div>
                            <div class="jarviswidget-editbox">
                            </div>
                            <div class="widget-body no-padding">
                                <form class="smart-form" action="<?= site_url('admin/save_contact_message'); ?>" method="POST">
 <fieldset>
                                ...
                                <label class="label">Mobile</label>
                                    <label class="input">
                                <input type="text" class="input-sm" id="mobile" value="<?php echo set_value('mobile', ''); ?>"  placeholder="Name" name="mobile" >
                                <span class="error"><?php echo form_error('mobile'); ?></span>
                               </label>
                                            </section><section  class="col col-6">
                                <label class="label">	message</label>
                                    <label class="input">
                                <input type="text" class="input-sm" id="	message" value="<?php echo set_value('	message', ''); ?>"  placeholder="Name" name="	message" >
