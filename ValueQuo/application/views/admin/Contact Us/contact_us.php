...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/Contact_us_controller/getcontact_usdata') ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, {'mRender': null}, {'mRender': null}, {'mRender': null}, {'mRender': null}, {'mRender': null}, {'mRender': null}, {"mRender": setStatus}, {"bSortable": false}],
            "fnCreatedRow": function (nRow, aData, iDataIndex) {
                $('td:eq(7) > label', nRow).attr('onclick', "changeStatus('id'," + aData[0] + ",'contact_detail')");
            },
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
                            ...
                            <header>
                                ...
                                <div class="jarviswidget-ctrls" role="menu" style="float:right;">
                                    ...
                                    <a class="button-icon" href="<?php print base_url(); ?>admin/add_contact_us"><i class="fa fa-plus-circle"></i></a>
                            ...
                            <div>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <input type="hidden" name="tab" value="contact_detail"/>
                                        <table class="dataTable table table-bordered " id="getData">
                                            <thead>
                                                <tr>
                                                    <th><input name="select_all" value="1" type="checkbox" class="select_all"/></th>
                                                    <th>Address</th><th>Email</th><th>Contact Number</th><th>Description</th><th>Latitude</th><th>Longitude</th><th>Status</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
