        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <form action="<?= site_url('admin/save_Settings'); ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Menu_name</label>
                                <input type="text" class="form-control" id="menu_name" value="<?php echo set_value('menu_name', ''); ?>"  placeholder="Name" name="menu_name" >
