...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/UserRequest_controller/getRequestdata') ?>',
            ...
            "fnCreatedRow": function (nRow, aData, iDataIndex) {
                $('td:eq(4) > label', nRow).attr('onclick', "changeStatus('id'," + aData[0] + ",'user_request')");
            },
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
                            ...
                            <header>
                                ...
                                <div class="jarviswidget-ctrls" role="menu" style="float:right;">
                                    ...
                                    <a class="button-icon" href="<?php print base_url(); ?>admin/add_Request"><i class="fa fa-plus-circle"></i></a>
