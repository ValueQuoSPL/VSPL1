                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-sm-offset-1 text-center">
                        <ul class="list-inline">
                            <li><a href="https://twitter.com/valuequo/" target="_blank">
                                <i class="fa fa-twitter fa-fw fa-lg"></i></a></li>
                            <li><a href="https://www.facebook.com/valuequo/" target="_blank">
                                <i class="fa fa-facebook fa-fw fa-lg"></i></a></li>
                            <li><a href="https://business.google.com/dashboard/l/07503485872609846197" target = "_blank" >
                                <i class="fa fa-google-plus fa-fw fa-lg"></i></a></li>
                            <li><a href="https://in.linkedin.com/" target="_blank">
                                <i class="fa fa-linkedin fa-fw fa-lg"></i></a></li>
                        </ul>
                    </div>
